    ...
    <section class="register-section">
      <div class="container">
        <div class="register-container">
          <h2 class="section-title">Registra tu Hotel</h2>
          <form class="register-form" action="registrar_hotel.php" method="POST">

            <div class="form-group">
              <label for="nombre"><i class="fas fa-hotel"></i> Nombre del Hotel</label>
            ...
            <div class="form-group">
              <label for="huespedes"><i class="fas fa-users"></i> Cantidad de Huéspedes</label>
            ...
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-save"></i> Registrar Hotel
            </button>
          </form>
        </div>
      </div>

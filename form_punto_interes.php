    ...
    <section class="register-section">
      <div class="container">
        <div class="register-container">
          <h2 class="section-title">Registrar Punto de Interés</h2>
          <form class="register-form" action="registro.php" method="POST">

            <div class="form-group">
              <label for="nombre"><i class="fas fa-hotel"></i> Nombre del Punto de Interés</label>
            ...
            <div class="form-group">
              <label for="descripcion"><i class="fas fa-users"></i> Descripcion del Punto de Interés</label>
              <input type="text" id="descripcion" name="descripcion" maxlength="150" required>
            </div>

            <div class="form-group">
              <label for="precio"><i class="fas fa-tags"></i> Precio</label>
            ...
            <div class="form-group">
                        ...
                        <select id="activity-type" name="activity-type">
                            ...
                            <option value="religioso">Centros Religiosos</option>
            ...
            <button type="submit" class="btn btn-primary">
              <i class="fas fa-save"></i> Registrar Punto de Interés
            </button>
          </form>
        </div>
      </div>
